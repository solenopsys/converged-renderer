...
const createDirective = <T extends keyof JSX.Directives>(
	name: T,
	fn: DirectiveFunction<ExtractArray<JSX.Directives[T]>>,
	options?: DirectiveOptions,
): Directive<ExtractArray<JSX.Directives[T]>> => {
	const immediate = !!options?.immediate;
	const data: DirectiveData<ExtractArray<JSX.Directives[T]>> = {
		fn,
		immediate,
	};
